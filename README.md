...
local Quests = {
    IceCreamIslandQuest = {{
        Level = 2125,
        LocationNpc = CFrame.new(-819.376709, 64.9259796, -10967.2832, -0.766061664, 0, 0.642767608, 0, 1, 0, -0.642767608, 0, -0.766061664),
        Number = 1,
    ...
    CakeQuest1 = {{
        Level = 2200,
        LocationNpc = CFrame.new(-2022.29858, 36.9275894, -12030.9766, -0.961273909, 0, -0.275594592, 0, 1, 0, 0.275594592, 0, -0.961273909),
        Number = 1,
    ...
    CakeQuest2 = {{
        Level = 2250,
        LocationNpc = CFrame.new(-1928.31763, 37.7296638, -12840.626, 0.951068401, -0, -0.308980465, 0, 1, -0, 0.308980465, 0, 0.951068401),
        Number = 1,
    ...
    ChocQuest1 = {{
        Level = 2300,
        LocationNpc = CFrame.new(231.75, 23.9003029, -12200.292, -1, 0, 0, 0, 1, 0, 0, 0, -1),
        Number = 1,
    ...
    ChocQuest2 = {{
        Level = 2350,
        LocationNpc = CFrame.new(151.198242, 23.8907146, -12774.6172, 0.422592998, 0, 0.906319618, 0, 1, 0, -0.906319618, 0, 0.422592998),
        Number = 1,
    ...
    CandyQuest1 = {{
        Level = 2400,
        LocationNpc = CFrame.new(-1149.328, 13.5759039, -14445.6143, -0.156446099, 0, -0.987686574, 0, 1, 0, 0.987686574, 0, -0.156446099),
        Number = 1,
    ...
    TikiQuest1 = {{
        Level = 2450,
        LocationNpc = CFrame.new(-16548.8164, 55.6059914, -172.8125, 0.213092566, -0, -0.977032006, 0, 1, -0, 0.977032006, 0, 0.213092566),
        Number = 1,
    ...
    TikiQuest2 = {{
        Level = 2500,
        LocationNpc = CFrame.new(-16541.0215, 54.770813, 1051.46118, 0.0410757065, -0, -0.999156058, 0, 1, -0, 0.999156058, 0, 0.0410757065),
        Number = 1,
